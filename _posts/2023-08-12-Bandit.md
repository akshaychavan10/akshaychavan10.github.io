...
style: fill
color: danger
description: OverTheWire Bandit series
---
...
# This is a sample private key for demonstration purposes.
# In a real scenario, you would use the key obtained from the challenge.
# Example format:
